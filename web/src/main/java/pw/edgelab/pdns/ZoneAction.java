...
import pw.edgelab.pdns.dataModel.ZoneDataModel;
import pw.edgelab.pdns.entities.Domain;
import pw.edgelab.pdns.entities.Domain.DomainType;
...
public class ZoneAction implements Serializable {
	...
	public void createZone(Domain domain){
		...
		if(existingDomain == null){
			...
			if(domain.getType().equals(DomainType.SLAVE)){
	...
	public String convertToMaster(Domain domain){
		...
		domain.setType(DomainType.MASTER);
		this.zoneDataModel.update(domain);
